...
public class ServerMain 
{
	...
	static void LoadFacilityData()
	{
		...
		//DataManager.AddARestroom(true, EXAMPLE_RESTROOM_FLOORNUM, EXAMPLE_MALE_RESTROOM_ROOMNUM, 2, 640, 450, 840, 660);
		//DataManager.AddARestroom(false, EXAMPLE_RESTROOM_FLOORNUM, EXAMPLE_FEMALE_RESTROOM_ROOMNUM, 3, 1200, 450, 1400, 660);
		
		// Restroom layout for the N1. Not really same though.. We might just use the above layout with the sample building's floor image.
